...
import { QuarterClosingOverlay } from "@/components/simulation/screens/QuarterClosingOverlay";
import type {
  Alloc,
  ArchetypeId,
  CompanyState,
    ...
    <TeachingContext.Provider value={notesOn}>
      ...
      <div className="flex h-full flex-col overflow-hidden">
        ...
        <div className="simulation relative isolate min-h-0 flex-1 overflow-hidden bg-base text-ink">
          ...
          {processingOverlay && (
            <QuarterClosingOverlay quarter={closingQuarter} error={error} onDismiss={() => setWorking(null)} dismissLabel={working?.dismiss} />
          )}
